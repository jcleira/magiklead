...
| [ ]  | 11 | [LinkedIn campaign: author + create in the app, manual start](./issues/11-campaign-creation-manual-start.md) — carries the copy gate (UI); step 0 done 2026-09-24 (DB bind); **blocked: no LinkedIn-ready prospect source** (PDL stores no `linkedin_url`) | [#6](./issues/06-day-one-connect-ceremony.md), [#10](./issues/10-plays-and-approved-copy.md) |
