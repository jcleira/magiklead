...
| [ ]  | 11 | [LinkedIn campaign: author + create in the app, manual start](./issues/11-campaign-creation-manual-start.md) — carries the copy gate (UI); step 0 done 2026-09-24 (DB bind); prospect source fixed 2026-09-24 (PDL stores `linkedin_url` + location); **ICP switched to the LLC plays** (founder, 2026-09-24); test data removed — next: founder searches + saves in `/leads` | [#6](./issues/06-day-one-connect-ceremony.md), [#10](./issues/10-plays-and-approved-copy.md) |
